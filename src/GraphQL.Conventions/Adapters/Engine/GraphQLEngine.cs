...
//        readonly GraphTypeAdapter _graphTypeAdapter = new GraphTypeAdapter(null);
...
//            public WrappedServiceProvider(Func<System.Type, object> typeResolutionDelegate)
//            {
...
//            {
//                return this.Resolve(serviceType.GetTypeInfo());
//            }
//        }
...
//            _typeResolver = typeResolver ?? new TypeResolver<ISchema, IGraphType>(typeResolutionDelegate.Invoke(typeof(GraphTypeAdapter)) as GraphTypeAdapter);
...
//                Inputs = inputs,
//                UserContext = UserContextWrapper.Create(userContext, serviceProvider ?? new WrappedServiceProvider(_constructor.TypeResolutionDelegate)),
